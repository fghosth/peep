...
var createByMysqlCmd = &cobra.Command{
	...
	Example: "projectCreate mcreate --mp /Users/derek/project/demo/gomybatis/model --mpn \"gomybatis/model\" --uri \"root:zaqwedcxs@tcp(localhost:3306)/hex_reports?charset=utf8mb4&parseTime=true\" --xp /Users/derek/project/demo/gomybatis/mysqlxml",
...
func init() {
	...
	createByMysqlCmd.PersistentFlags().StringVar(
		&mysql.Mysqluri,
		"uri",
		"root:zaqwedcxs@tcp(localhost:3306)/hex_reports?charset=utf8mb4&parseTime=true",
		"mysql uri",
	)
	createByMysqlCmd.PersistentFlags().StringVar(
