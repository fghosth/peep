...
var createProjectCmd = &cobra.Command{
	...
	Example: "./c pcreate --module \"hexcloud.net/reportssss\" --path /Users/derek/project/demo/gomybatis/tmp",
	Run: func(cmd *cobra.Command, args []string) {
		...
		projectInit.CreateMakefile(projectPath)
		projectInit.CreateEntrypoint(projectPath)
		projectInit.CreateCMDUpFile(projectPath + "/cmd/cmd")
