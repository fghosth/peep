...
* 生成项目结构
```
peep pcreate --module "hexcloud.net/reportssss" --path /Users/derek/project/demo/gomybatis/tmp
```
* mysql脚手架生成
```
peep mcreate --mp /Users/derek/project/demo/gomybatis/model --mpn "gomybatis/model" --uri "root:zaqwedcxs@tcp(localhost:3306)/hex_reports?charset=utf8mb4&parseTime=true" --xp /Users/derek/project/demo/gomybatis/mysqlxml
```
